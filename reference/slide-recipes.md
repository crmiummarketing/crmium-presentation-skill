...
Q&A слайд має QR код на форму. Усі питання з форми попадають у CRMiUM CRM як новий лід — спікер або команда дає персональну відповідь поза рамками виступу. Тон формальний (Ви, не Ти) — аудиторія часто власники та C-level. QR картинка — `assets/crmium-ask-question-qr.png`.
  ...
  <div class="slide-content qa-grid">
    <div class="qa-text-side">
      ...
      <p class="qa-sub reveal">
        Якщо у вас залишилися питання — скануйте QR.
        Ми дамо персональну відповідь кожному.
      </p>
    </div>
